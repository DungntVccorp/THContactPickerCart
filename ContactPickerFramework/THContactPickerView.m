...
#define kVerticalPadding 6 // amount of padding above and below each contact bubble
#define kTextViewMinWidth 50
...
- (void)setup {
    ...
    self.textView.textColor = [[UIColor alloc] initWithRed:169.0/255.0 green:177.0/255.0 blue:188.0/255.0 alpha:1.0];
...
- (void)layoutView {
    ...
    for (id contactKey in self.contactKeys){
        ...
        if(bubbleFrame.origin.x == 2){
            bubbleFrame.origin.x += 8;
        }
